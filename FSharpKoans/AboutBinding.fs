...
*)
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        ...
        let y = "sara" // replace with a string
        let z = 1.1 // replace with anything else!
    ...
    let ``09 A wildcard pattern will match anything`` () =
        ...
        let _ = "mae" // replace with a string
        let _ = 2.1 // replace with anything else!
        ()
